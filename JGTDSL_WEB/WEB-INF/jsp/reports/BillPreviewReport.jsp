...
<script  type="text/javascript">
	navCache("billPreviewHome.action");
	setTitle("Monthly Bill Preview Report Generation");
</script>
		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				<div class="w-box-header">
    				<h4 id="rightSpan_caption">Monthly Bill Preview Report</h4>
				</div>
				<div class="w-box-content" style="padding: 10px;" id="content_div">
				
     				<form id="billProcessForm" name="billProcessForm" action="BillPreview" style="margin-bottom: 1px;">
						<div class="row-fluid">
							<div class="span12">
									...
									<table width="100%" align="center">
										<tr>
											<td width="100%" align="right" style="font-size: 12px;font-weight: bold;">
												<input type="radio" value="area_wise" id="area_wise" checked name="report_for" onclick="checkType(this.id)"/> Area Wise&nbsp;&nbsp;&nbsp;
							...
							<div class="span6">									    
								...
								<select id="area_id"  style="width: 56%;"  name="area_id">
									...
									<s:iterator value="%{#session.USER_AREA_LIST}" id="areaList">
										<option selected value="<s:property value="area_id" />" ><s:property value="area_name" /></option>
								</s:iterator>
								</select>									      
							</div>
							<div class="span6">
						   ...
						   <table width="100%">
						   	<tr>
						   		...
						   		<td style="" align="right">
						   			...
						   			<input type="radio" checked name="report_type" value="0"> Not Approved 
						   			<input type="radio" name="report_type" value="1"> Approved & Unpaid 
						   			<input type="radio" name="report_type" value="2"> Approved & Collected 
