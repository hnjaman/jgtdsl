...
<script  type="text/javascript">
	navCache("categoryWiseGasConsumption.action");
	setTitle("Category Wise Gas Consumption");
</script>
		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				...
				<div class="w-box-content" style="padding: 10px;" id="content_div">
     				...
     				<form id="billProcessForm" name="billProcessForm" action="categoryWiseGasConsumptionForm.action" style="margin-bottom: 1px;">
