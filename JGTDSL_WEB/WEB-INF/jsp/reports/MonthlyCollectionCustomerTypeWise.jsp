...
<script  type="text/javascript">
	navCache("monthlyCollectionCustomerTypeWise.action");
	setTitle("Monthly Collection Customer Type Wise");
</script>
		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				<div class="w-box-header">
    				<h4 id="rightSpan_caption">Category Wise Gas Consumption</h4>
				</div>
				<div class="w-box-content" style="padding: 10px;" id="content_div">
				
     				<form id="billProcessForm" name="billProcessForm" action="monthlyCollectionCustomerTypeWiseForm.action" style="margin-bottom: 1px;">
						...
						<div class="row-fluid">							
							...
							<div class="span6">
								...
								<select id="customer_category" style="width: 56%;"  name="customer_category" onchange="fetchCategoryName()">
