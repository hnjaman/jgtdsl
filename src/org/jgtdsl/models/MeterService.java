...
public class MeterService {
	...
	public ArrayList<CustomerApplianceDTO> getApplianceList(int index, int offset,String whereClause,String sortFieldName,String sortOrder,int total)
	{
		String customer_id=whereClause.split("=")[1].replaceAll("'", "");
	...
	public ArrayList<CustomerApplianceDTO> getCustomerApplianceList(String customer_id)
	{		
		UserDTO loggedInUser=(UserDTO) ServletActionContext.getRequest().getSession().getAttribute("user");
		...
		CustomerApplianceDTO appliance=null;
			try
			{
				...
				{				
					...
					appliance.setApplianc_qnt_billcal(r.getString("NEW_APPLIANCE_QNT_BILLCAL"));
					appliance.setApplianc_perm_diss(r.getString("TOTAL_PDISCONNECTED_QNT"));
					appliance.setApplianc_temp_diss(r.getString("TOTAL_TDISCONNECTED_QNT"));
					appliance.setApplianc_partial_diss(r.getString("TOTAL_PARTIAL_DISS_QNT"));
